...
║  Version: 2.0  |  By: @I_tt_6  |  Admin: elmodmen                       ║
╠══════════════════════════════════════════════════════════════════════════╣
...
MASTER_USERNAME      = MASTER_CONFIG.get('master_username', 'elmodmen')
...
<div class="foot">All rights reserved © SERVER HUB — By @I_tt_6</div>
</div></body></html>
'''
    ...
    <div class="section-body">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px;margin-top:10px">
        <a href="https://t.me/I_tt_6" target="_blank" style="text-decoration:none">
          <div class="stat-card"><div class="lbl">👨‍💻 Developer</div><div class="val" style="font-size:12px;color:var(--accent)">@I_tt_6</div></div>
        </a>
        <a href="https://t.me/Notfound_ELMODMEN" target="_blank" style="text-decoration:none">
          <div class="stat-card"><div class="lbl">📢 Channel</div><div class="val" style="font-size:12px;color:var(--yellow)">@elmodmen</div></div>
        </a>
    ...
    if username in users and users[username].get('password') == h:
        if not users[username].get('active', False):
            ...
            return render_template_string(AUTH_TEMPLATE,
                error='⚠️ Your account is pending Admin approval. Contact @I_tt_6',
                error_type='login')
...
|_____|_____|_|  |_|\___/|____/|_|  |_|_____|_| \_|'''+R)
    print(P+'\u2554'+'\u2550'*64+'\u2557'+R)
    print(P+'\u2551  \U0001f680  '+B+C+'\U0001d834\U0001d835\U0001d836\U0001d837\U0001d838\U0001d839\U0001d83a\U0001d83b'+R+P+'  \u2015  SERVER HUB v2.0  \u2015  @I_tt_6      \u2551'+R)
    print(P+'\u255a'+'\u2550'*64+'\u255d'+R)
